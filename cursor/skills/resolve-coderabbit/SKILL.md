...
- REJECT suggestions that violate YAGNI, project architecture, or project conventions
...
5. **Check architecture alignment** — conflicts with project conventions?
...
- **Architecture conflict**: Violates project conventions or patterns
...
- Do NOT implement suggestions that conflict with project conventions
