...
- Only `README.md` and AI instructions file (`CLAUDE.md` / `.cursor/rules/`) in project root
...
- Read README.md, CLAUDE.md (or .cursor/rules/), docs/*
...
├── CLAUDE.md / .cursor/rules/  # AI instructions only
└── docs/
    ├── README.md     # Index
    └── *.md          # All other docs
```
