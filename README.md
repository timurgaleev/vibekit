...
sub-agents and a statusline that install into `~/.claude`,
...
- **Shows what it's doing.** A live statusline tells you the model, cost,
  context use, and how long until the token window resets.
